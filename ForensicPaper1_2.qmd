...
mydoi = c("https://doi.org/10.1002/14651858.CD005960.pub2")
dl_path = "C:\\Users\\cscho\\Documents\\GitHub\\ForensicPaper1_2"

get.review(doi = mydoi, dl_path, show.terms = TRUE)

CochraneRev = read.review(file = "CD005960StatsDataOnly.rm5", path = dl_path)
...
```{r}
studies = CochraneRev[[1]]
ma = CochraneRev[[2]]
```

```{r}
tab.ma <- ma |> dplyr::filter(
  outcome.id == "CMP-001.06"
)
```

```{r}

idx = studies$comparison.nr == 1 & studies$outcome.nr == 6
